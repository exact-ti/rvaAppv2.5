...
class ColorLoader extends StatefulWidget {
  ...
  ColorLoader(
      {this.color1 = StylesThemeData.PRIMARY_COLOR,
      this.color2 = StylesThemeData.SECOND_COLOR,
      this.color3 = StylesThemeData.PRIMARY_COLOR});

  @override
  _ColorLoader2State createState() => _ColorLoader2State();
}

class _ColorLoader2State extends State<ColorLoader>
